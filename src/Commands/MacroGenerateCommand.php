...
namespace SirMathays\Convenience\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Str;
use SirMathays\Convenience\Foundation\MacroServiceProvider;
use SirMathays\Convenience\MacroServiceProvider as NativeMacroServiceProvider;
...
class MacroGenerateCommand extends Command
{
    ...
    public function handle()
    {
        $providers = array_filter(
            ...
            fn ($provider) => ! $provider instanceof NativeMacroServiceProvider
        );
